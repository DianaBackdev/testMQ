...
(function (h) {
        ...
        var d, e, f = a.aoColumns, b = function (b) {
            if (b && b.time) {
                ...
                if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < +new Date - 1E3 * g) && !(b.columns && f.length !== b.columns.length))) {
                    ...
                    b.order !== k && h.each(b.order, function (b, c) {
                        a.aaSorting.push(c[0] >= f.length ? [0, c[1]] : c);
                    });

                    // Установка начальной сортировки по убыванию, если нет сохранённого порядка
                    b.order === k && (a.aaSorting = [[0, 'desc']]);
   ...
   /* h.extend(l.ext.classes, {
        ...
        sSortAsc: " ",
        sSortDesc: " ",
        sSortable: " ", // Используем "sorting_disabled" для отключения сортировки
        sSortableAsc: " ",
        sSortableDesc: " ",
        sSortableNone: " ", // Отключаем сортировку
        sSortColumn: " ",
        sFilterInput: " ",
        sLengthSelect: " ",
    ...
    h.extend(l.ext.classes, {
        ...
        sSortAsc: "",  // Отключаем визуальные индикаторы сортировки (или оставляем пустым)
        sSortDesc: "", // Отключаем визуальные индикаторы сортировки (или оставляем пустым)
        sSortable: "sorting_disabled", // Отключаем сортировку по умолчанию
        sSortableAsc: "", // Отключаем визуальные индикаторы сортировки (или оставляем пустым)
        sSortableDesc: "", // Отключаем визуальные индикаторы сортировки (или оставляем пустым)
        sSortableNone: "", // Отключаем визуальные индикаторы сортировки (или оставляем пустым)
        sSortColumn: "", // Отключаем визуальные индикаторы сортировки (или оставляем пустым)
        sFilterInput: "",
        sLengthSelect: "",
